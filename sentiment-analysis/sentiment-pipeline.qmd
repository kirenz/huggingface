...
- *Twitter-roberta-base-sentiment* is a roBERTa model trained on ~58M tweets and fine-tuned^[Fine-tuning is the process of taking a pre-trained large language model (e.g. roBERTa in this case) and then tweaking it with additional training data to make it perform a second similar task (e.g. sentiment analysis)] for sentiment analysis.
